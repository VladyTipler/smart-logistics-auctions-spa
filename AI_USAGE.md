...
- переработал бы фильтрацию в независимый типобезопасный config-driven движок: он принимал бы любой строгий список описаний фильтров с их типами и поведением, а вся аукционная специфика свелась бы к одному объекту `auctionFilterConfig`, формирующему `AuctionListRequest`;
